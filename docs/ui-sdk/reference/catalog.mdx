...
<AccordionGroup>
  ...
  <Accordion title="Skills">
    ...
    <Frame caption="Importing a skill from a GitHub repository in the Skills settings panel.">
      <img src="/images/add-skill.png" alt="The Import from GitHub skill dialog with name, description, repository URL, path, and ref fields" />
    </Frame>
  </Accordion>
  ...
  <Accordion title="Sandbox providers">
    ...
    interface SandboxCatalogServer {
      ...
      listSandboxProviders(req?: { query?: string }): Promise<SandboxProviderBase[]>;
    ...
    <Frame caption="Configuring a sandbox provider (Daytona) in the Sandbox providers settings panel.">
      <img src="/images/add-sandbox.png" alt="The sandbox provider configuration dialog with snapshot name, timeouts, lifecycle intervals, and API key" />
    </Frame>
  </Accordion>
</AccordionGroup>
