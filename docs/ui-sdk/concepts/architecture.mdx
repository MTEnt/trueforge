...
description: "The pieces you compose: providers, layouts, containers, and slots."
---
...
<Steps>
  ...
  <Step title="Supply your own layout">
    Pass a component to `layout` and arrange the exported containers yourself.
  </Step>
  <Step title="Mount the providers yourself">
    Skip `TrueforgeUI` entirely and compose the providers directly.
  </Step>
</Steps>
...
`TrueforgeUI` mounts this for you. You only need it when composing manually:
